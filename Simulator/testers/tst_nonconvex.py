...
plotter.save(figure_folder_name+f'pretrain dtheta = [{dtheta[0]:.2e},{dtheta[1]:.2e},{dtheta[2]:.2e}].png')
...
plotter.save(figure_folder_name+f'biasnet dtheta = [{dtheta[0]:.2e},{dtheta[1]:.2e},{dtheta[2]:.2e}].png')
plotter.remove_shape(plotter.shapes[-1]['id'])
...
plotter.save(figure_folder_name+f'fullnet dtheta = [{dtheta[0]:.2e},{dtheta[1]:.2e},{dtheta[2]:.2e}].png')
